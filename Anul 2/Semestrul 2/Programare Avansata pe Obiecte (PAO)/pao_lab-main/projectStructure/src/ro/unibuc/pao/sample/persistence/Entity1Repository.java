package ro.unibuc.pao.sample.persistence;

import ro.unibuc.pao.sample.domain.Entity1;

import java.util.Arrays;

/**
 * Repositories are responsible for interacting with the backing storage of entities. Usually a 1-to-1 relation with the
